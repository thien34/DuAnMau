...
public final class Home extends javax.swing.JFrame {
    ...
    void startClock() {
        new Thread(() -> {
            while (true) {
                jLabel2.setText(new SimpleDateFormat("hh:mm:ss a").format(Calendar.getInstance().getTime()));
            }
        }).start();
    }
    ...
    private void initComponents() {
        ...
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Boy.png"))); // NOI18N
        ...
        jMenuItem1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Boy.png"))); // NOI18N
